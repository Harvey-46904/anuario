...
class UserController extends VoyagerBaseController
{
    ...
    public function edit(Request $request, $id)
    {
        ...
        return Voyager::view($view, compact('dataType', 'dataTypeContent', 'isModelTranslatable','colegios'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        if(!$request->has('role_id')){
            $request->merge(['role_id' => $data->role_id]);
        }
    ...
    {
        $colegios = Colegio::all(); // Obtener todos los colegios
    ...
    public function store(Request $request)
    {
        ...
        $data = $this->insertUpdateDatabeta($request, $slug, $dataType->addRows, new $dataType->model_name());
    ...
    public function insertUpdateDatabeta($request, $slug, $rows, $model)
{
    ...
    if (isset($data['password']) && !empty($data['password'])) {
        $data['password'] = bcrypt($data['password']); // Cifrar la contraseña
    }
     // Verificar y manejar el campo `rol`
     if (isset($data['role_id'])) {
        $model->role_id = $data['role_id']; // Asignar el rol
    }
    ...
    if ($request->hasFile('avatar')) {
        ...
        $destinationPath = public_path('storage/users/' . $datePath);
        $file->move($destinationPath, $filename);

        // Asignar la ruta del archivo al campo `avatar`
        $data['avatar'] = 'users/' . $datePath . '/' . $filename;
    }
