...
@section('page_header')
    <div class="container-fluid">
        <h1 class="page-title">
            <i class="voyager-person"></i> {{ __('Anuario') }}
        </h1>
        <a href="{{ route('exel', ['id_anuario' => $anuario]) }}" class="btn btn-success btn-add-new">
            <i class="voyager-plus"></i> <span>{{ __('Agregar Estudiante') }}</span>
        </a>
    </div>
@stop
...
@section('content')
    ...
    <div class="alert alert-success" role="alert">
            Estudiantes agregados correctamente al anuario
        </div>
    @endif
