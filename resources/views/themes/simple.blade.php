    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top shadow-sm" id="mainNav">
            <div class="container px-2">
                <a class="navbar-brand text-center" href="">{{ $response["colegio"]->nombre_colegio}}</a>
                    ...
                    <div class="col-lg-12 order-lg-1 mb-5 mb-lg-0">
                        <div class="container-fluid px-5">
                            <div class="row gx-5">
                                ...
                                @foreach ($response["estudiantes"] as $item)
                                    <div class="col-md-4 mb-5">
                                        <div class="text-center">
                                        <img src="{{ filter_var($item->avatar, FILTER_VALIDATE_URL) ? $item->avatar : Voyager::image( $item->avatar ) }}" class="img-circle img-fluid" alt="Imagen Circular">
                                            <h3 class="font-alt">{{$item->name}}</h3>
                                           
                                        <a href="{{route('anuarios_personal.index', ['serie_id_anuario' => $response['id_anuario'],'id_estudiante'=>$item->id])}}" class="link-container">
                                            <div class="bg-gradient-primary-to-secondary p-2">
                                                <h5 class="font-alt text-white">Recuerdos</h5>
                                            </div>
                                        </a>
